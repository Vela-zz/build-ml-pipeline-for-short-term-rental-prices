...
def go(args):
    ...
    min_num_of_reviews, max_num_of_reviews = find_outliers_by_IQR(df.number_of_reviews)  # NOQA:E501
    idx = df['number_of_reviews'].between(min_num_of_reviews,
                                          max_num_of_reviews)
    df = df[idx].copy()
    # Drop minimum_nights outliers
    min_minimum_nights, max_minimum_nights = find_outliers_by_IQR(df.minimum_nights)  # NOQA:E501
    ...
    idx = df['calculated_host_listings_count'].between(min_calculated_host_listings_count,  # NOQA:E501
